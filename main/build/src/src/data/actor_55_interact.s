...
_actor_55_interact::
        ...
        VM_IF_CONST             .EQ, VAR_LADY7, 4, 1$, 0
        ...
        VM_RPN
            ...
            .R_OPERATOR .ADD
            .R_STOP
        VM_SET                  VAR_LADY7, .ARG0
        VM_POP                  1

        VM_JUMP                 2$
1$:
        ; Variable Set To False
        VM_SET_CONST            VAR_LADY7, 0
...
2$:
        ...
        VM_IF_CONST             .EQ, VAR_LADY7, .DIR_LEFT, 3$, 0
        VM_IF_CONST             .EQ, VAR_LADY7, .DIR_RIGHT, 4$, 0
        VM_IF_CONST             .EQ, VAR_LADY7, .DIR_UP, 5$, 0
