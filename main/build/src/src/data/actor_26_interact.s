...
1$:
        ...
        VM_SET                  VAR_S14A4_LOCAL_4, ^/(.LOCAL_ACTOR + 1)/

        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S14A4_LOCAL_4, 0, 3$, 0
        VM_JUMP                 4$
3$:
        ; Actor Set Active
...
4$:
        ...
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S14A4_LOCAL_4, 1, 5$, 0
        VM_JUMP                 6$
5$:
        ; Actor Set Active
...
6$:
        ...
        ; If Variable .EQ Value
        VM_IF_CONST             .EQ, VAR_S14A4_LOCAL_4, 2, 7$, 0
        VM_JUMP                 8$
7$:
        ; Actor Set Active
...
8$:
        ...
        VM_IF_CONST             .GT, VAR_S14A4_LOCAL_4, 2, 9$, 0
        VM_JUMP                 10$
9$:
        ; If Variable .EQ Value
...
10$:
        ...
        VM_PUSH_CONST           VAR_S14A4_LOCAL_0 ; Variable V0
